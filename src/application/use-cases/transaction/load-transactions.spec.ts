...
describe('LoadTransactions', () => {
  ...
  it('should return a list of transactions', async () => {
    const transaction1 = new Transaction({ senderId: '1', receiverId: '2', amount: 50, status: 'completed' });
    const transaction2 = new Transaction({ senderId: '3', receiverId: '4', amount: 100, status: 'completed' });
